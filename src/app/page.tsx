  ...
  return (
    <main>
      ...
      <section className="hero section-grid" id="home">
        <Reveal className="hero-intro"><p className="eyebrow">Frontend / Product</p><h1>Frontend Developer.<br /><em>Product-minded.</em></h1><p className="hero-copy">I build responsive, usable web products with React, Next.js, and JavaScript. I care about more than getting an interface to look right - I think about the people using it, the problem the product is solving, and how the frontend can make that experience clearer and more effective.</p><div className="action-row"><a className="button button-outline" href="#projects">View my work <ArrowUpRight size={15} /></a><span className="cv-action"><span className="cv-note">( View on desktop )</span><a className="text-link" href="/omoseebi-vincent-cv.docx" download>Download my CV <ArrowUpRight size={15} /></a></span></div></Reveal>
